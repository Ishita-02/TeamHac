...
function applyEmail(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { userEmail, teamName, applierEmail, applierName, applierGitHub, applierSkills, } = req;
        ...
        try {
            ...
            const mailOptions = {
                ...
                html: yield renderEmailTemplate(teamName, applierEmail, applierName, applierGitHub, applierSkills),
            };
            // Send the email
...
function renderEmailTemplate(teamName, applierEmail, applierName, applierGitHub, applierSkills) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
