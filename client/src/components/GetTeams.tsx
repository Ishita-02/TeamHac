...
/*<Card key={team._id} className="w-64 h-64 relative">
                <div className="flex flex-col">
                  <h1 className="text-xl font-bold mt-2 absolute top-0 left-0 ml-3">{team.username}</h1>
                  <h1 className="text font">{team.email}</h1>
                  <div className="flex items-center">
                    <p className="text font-bold absolute right-0 mt-8 mr-2">{team.place}</p>
                    <img
                      src={location}
                      alt="location"
                  ...
                  <div className="absolute bottom-0 right-0 p-2">
                    <img
                      src={github_icon}
                      alt="github"
                      className="w-8 h-8 cursor-pointer mb-1.5 rounded-full"
                      onClick={() => openGithub(team.githubLink)}
                    />
                  </div>
                </div>
